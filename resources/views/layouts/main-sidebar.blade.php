            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        </svg><span class="side-menu__label">{{ trans('app.home') }}</span></a>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">{{ trans('app.invoices') }}</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        <li><a class="slide-item"
                                href="{{ url('/' . ($page = 'invoices')) }}">{{ trans('app.invoices_list') }}</a></li>
                        @can('edit invoice')
                            <li><a class="slide-item"
                                    href="{{ url('/' . ($page = 'chart-flot')) }}">{{ trans('app.paid_invoices') }}</a></li>
                            <li><a class="slide-item"
                                    href="{{ url('/' . ($page = 'chart-chartjs')) }}">{{ trans('app.unpaid_invoices') }}</a></li>
                            <li><a class="slide-item"
                                    href="{{ url('/' . ($page = 'chart-echart')) }}">{{ trans('app.partially_paid_invoices') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">{{ trans('app.reports') }}</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        <li><a class="slide-item"
                                href="{{ url('/' . ($page = 'cards')) }}">{{ trans('app.invoice_reports') }}</a></li>
                        <li><a class="slide-item"
                                href="{{ url('/' . ($page = 'darggablecards')) }}">{{ trans('app.client_reports') }}</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">{{ trans('app.settings') }}</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        <li><a class="slide-item"
                                href="{{ url('/' . ($page = 'sections')) }}">{{ trans('app.sections') }}</a></li>
                        <li><a class="slide-item"
                                href="{{ url('/' . ($page = 'products')) }}">{{ trans('app.products') }}</a></li>
                    </ul>
                </li>
