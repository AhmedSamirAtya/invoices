        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/search_customers" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
@php $selectedSectionId = old('section_id', $section_id ?? null); @endphp
                        <div class="col">
                        ...
                        <div class="col-lg-3" id="start_at">
                            ...
                            <div class="input-group">
                                ...
                                </div><input class="form-control fc-datepicker" value="{{ old('start_at', $start_at ?? '') }}"
                        ...
                        <div class="col-lg-3" id="end_at">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    ...
                                    value="{{ old('end_at', $end_at ?? '') }}" placeholder="YYYY-MM-DD" type="text">
                            </div><!-- input-group -->
                        </div>
                    </div><br>
