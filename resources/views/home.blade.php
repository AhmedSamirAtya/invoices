@php
    $invoices = \App\Models\Invoice::with('details')->get();
    ...
    // 2. Use the reduce method to calculate the sum of the paid portion for partially paid invoices
    $partialyPaidSum = $invoices->reduce(function ($carry, $invoice) {
        // Check if the invoice is partially paid: total_paid is > 0 and < amount_collection
        // NOTE: Assuming your status accessor correctly returns 'partially_paid'
        if ($invoice->status === 'partially_paid') {
            // Find the amount already paid (from your accessor logic)
            $paidAmount = $invoice->totalPaid;

            // Add the paid amount to the running total (carry)
            return $carry + $paidAmount;
        }

        // Otherwise, return the current running total
        return $carry;
    }, 0);
    ...
    $paidSum = $invoices->reduce(function ($carry, $invoice) {
    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{ __('app.invoices_count') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{ count($invoices) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{ __('app.cash') }} --
                                    {{ \App\Models\InvoiceDetails::sum('amount_collection') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{ __('app.unpaid_invoices') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{ $unpaidCount }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{ __('app.cash') }} --
                                    {{ \App\Models\Invoice::getTotalFullyUnpaidAmount() }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{ __('app.paid_invoices') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{ $paidCount }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{ __('app.cash') }} -- {{ $paidSum }}</p>
                            </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{ __('app.partialy_paid_invoices') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{ $partialyPaidCount }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{ __('app.cash') }} -- {{ $partialyPaidSum }}</p>
                            </div>
                        </div>
                    </div>
                </div>
